...
namespace DataAccessLayer
{
    public class clsInternationalLicenseData
    {
        ...
        public static bool GetInternationalLicenseByApplicationID(ref int InternationalLicenseID, int ApplicationID, ref int DriverID, ref int IssuedUsingLocalLicenseID, ref DateTime IssueDate, ref DateTime ExpirationDate, ref bool IsActive, ref int CreatedByUserID)
        {
            bool isFound = false;
        ...
        public static bool GetInternationalLicenseByLocalLicenseID(ref int InternationalLicenseID, ref int ApplicationID, ref int DriverID, int IssuedUsingLocalLicenseID, ref DateTime IssueDate, ref DateTime ExpirationDate, ref bool IsActive, ref int CreatedByUserID)
        {
            bool isFound = false;
        ...
        public static DataTable GetAllInternationalLicenses()
        {
            ...
            string query = @"SELECT InternationalLicenseID as 'Int.LicenseID', ApplicationID, DriverID, IssuedUsingLocalLicenseID as LocalLicenseID, IssueDate, ExpirationDate, IsActive
        ...
        // other
        public static bool IsInternationalLicenseExpired(int InternationalLicenseID)
        {
            bool isFound = false;
            string query = "SELECT Found=1 FROM InternationalLicenses WHERE InternationalLicenseID = @InternationalLicenseID";
            try
        ...
        public static bool DoesLicenseHaveAnActiveInternationalLicense(int LocalLicenseID)
        {
            bool isFound = false;
            string query = @"SELECT * FROM InternationalLicenses
        ...
        public static bool IsInternationalLicenseActive(int LocalLicenseID)
        {
            bool isFound = false;
            string query = @"UPDATE InternationalLicenses
                                    SET IsActive = 0
                                    WHERE IssuedUsingLocalLicenseID = @LocalLicenseID
                                      AND GETDATE() NOT BETWEEN IssueDate AND ExpirationDate


                                    SELECT top 1 1 FROM InternationalLicenses
                                        WHERE IssuedUsingLocalLicenseID = @LocalLicenseID
                                        and IsActive = 1;";
            try
            {
